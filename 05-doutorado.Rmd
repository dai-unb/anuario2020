...
## Alunos regulares ativos, matrículas e aprovações em disciplinas nos cursos de doutorado, por unidade acadêmica e curso, UnB, 2019
...
## Alunos regulares registrados nos cursos de doutorado, por sexo e faixa etária, UnB, 2019
...
## Alunos regulares registrados nos cursos de doutorado, por semestre, unidade acadêmica, curso e sexo UnB, 2019
...
## Alunos regulares registrados ativos e com trancamento geral de matrícula nos cursos de doutorado, por semestre, sexo, unidade acadêmica e curso, UnB, 2019
...
tab12 <- rio::import("dados_doutorado/Tabelas_Doutorado_Anuário_2019.xlsx", 
                    sheet = "Tabela 3.06",
                    skip = 1)
# xfun::embed_file("dados_doutorado/EvoForD.csv")

 tab12 %>% 
  tabela_geral("Número de alunos regulares registrados nos cursos de pós-graduação Stricto Sensu por sexo, unidade acadêmica e curso, UnB, 2019 (2º semestre)", 
               linhatotal = TRUE, 
               tamfonte = 12,
               colunas = c("Unidade Acadêmica/Curso", "Fem. Mest.", "Masc. Mest.", "Tot. Mest.", "Fem. Dout.", "Masc. Dout.", "Tot. Dout.", "Total"),  
               fundo = fundo) %>% 
   colorir(dados = tab12)
```

## Número de cursos e alunos regulares registrados nos cursos de pós-graduação Stricto Sensu por unidade acadêmica e curso, UnB, 2018 (2º semestre)

```{r}

tab13 <- rio::import("dados_doutorado/Tabelas_Doutorado_Anuário_2019.xlsx", 
                    sheet = "Tabela 3.07",
                    skip = 1)
# xfun::embed_file("dados_doutorado/EvoForD.csv")

 tab13 %>% 
  tabela_geral("Número de cursos e alunos regulares registrados nos cursos de pós-graduação Stricto Sensu por unidade acadêmica e curso, UnB, 2018 (2º semestre)", 
               linhatotal = TRUE, 
               tamfonte = 12,
               colunas = c("Unidade Acadêmica/Curso", "Cur. Mest.", "Alun. Mest.", "Cur. Dout.", "Alun. Dout.", "Total"),  
               fundo = fundo)
