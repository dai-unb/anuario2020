...
load("labels/Label2.RData")

### lê o arquivo que foi importado do CenSup
### http://sistemascensosuperior.inep.gov.br/censosuperior_2019/
### caminho: migração -> exportar dados -> aluno
### colocar o arquivo TXT dentro da pasta "dados_censo"
Censo <- rio::import("dados_identificados/Aluno.txt",
                     format = "|",
                     skip = 1,
                     fill = TRUE
)
...
names(Arquivo42) <- c(
  ...
  "Sem_Conclusao", "Parfor", "Sem_Ingresso", "Tipo_Escola", "Ing_Vest", "Ing_Enem", "Ing_Pas", "Ing_Sel", 
  "Ing_Bili", "Ing_PECG", "Ing_Trans", "Ing_Judicial", "Ing_Rem", "Ing_Esp", "Mob_Acad", "Tipo_Mob_Acad", 
  "IES_Destino", "Tipo_Mob_Int", "Pais_Dest", "Cotas", "Cota_Etnica", "Cota_Deficientes", "Cota_Escola", "Cota_Social", 
  "Cota_Outras", "Fin_Est", "Fin_Fies", "Fin_Estado", "Fin_Municipal", "Fin_Les", "Fin_Ext", "Fin_Prounip", 
  "Fin_Exts", "Fin_Estados", "Fin_ies", "Fin_Munics", "Fin_Municss", "Apoio_Social", "Apoio_Alimen", "Apoio_Moradia", 
  "Apoio_Trans", "Apoio_Mat_Did", "Apoio_Trab", "Apoio_Perm", "Atv_Ext_Cur", "Pesquisa", "Bolsa_Pesquisa", "Extensao", 
  "Bolsa_Extensao", "Monitoria", "Mon_Remun", "EnO", "Bolsa_EnO", "CH_Total", "CH_Integral"
)
...
### e arruma a base 42
Arquivo42 <- Arquivo42 %>% 
  mutate(ID_Inep = as.double(Censo$V2))
