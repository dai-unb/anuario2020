...
## Indicadores gerais de desempenho da UnB, 2009 a 2019
```{r}
...
indicadores_gerais %>% 
  ...
  map_df(~replace_na(., "")) %>%
  tabela_geral("Indicadores gerais de desempenho da UnB, 2009 a 2019", 
               linhatotal = F, 
               tamfonte = 10, 
               fundo = fundo) %>% 
...
## Gráfico Evolução da população universitária da UnB, 2015 a 2019

<br>

## Gráfico Evolução da população universitária da UnB por categoria, 2015 a 2019
...
## Gráfico Evolução da população universitária da UnB, 2015 a 2019 (2º semestre)

<br>

## Gráfico Evolução do número de alunos registrados na pós-graduação Stricto Sensu, 2015 a 2019 (2º semestre)
...
## Gráfico Total de alunos formados na graduação, na especialização, no mestrado e no doutorado por período, 1966 a 2019
