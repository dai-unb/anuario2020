...
graf1 %>% 
  ...
  labs(y = "Forma de ingresso",
       title = "Ingresso de alunos nos cursos de graduação pelo vestibular, PAS, ENEM e outras vias, UnB, 2019",
...
graf2 %>% 
  ...
  labs(y = "Unidade acadêmica",
       title = "<span style='color:#7FB8DD'>Ingressantes</span> e <span style='color:#0071BB'>formados</span> nos cursos de graduação, por unidade acadêmica, UnB, 2019",
       caption = "Fonte: Censo da Educação Superior 2019")
```
...
## Alunos regulares ativos nos cursos de graduação, por unidade acadêmica e sexo, UnB, 2019
```{r}
# tabela 17
...
tab6 %>% 
  tabela_geral(
    titulo = "Alunos regulares ativos nos cursos de graduação, por unidade acadêmica e sexo, UnB, 2019",
...
## Alunos estrangeiros regulares registrados nos cursos de graduação, por continente e país, UnB, 2019 (2º semestre)
```{r}
# tabela 26
