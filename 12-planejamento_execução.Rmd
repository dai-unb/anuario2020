...
dpo %>%
  map_df(~ replace_na(., 0)) %>%
  tabela_geral("Orçamento da FUB – por grupos de despesas nas fontes Tesouro e Recursos Próprios (PLOA), 2019", 
               linhatotal = FALSE, 
               colunas = c("Item", "GRUPO DE DESPESA", "TESOURO", "(%)", "PRÓPRIOS", "(%)", "TOTAL", "(%)"), 
               tamfonte = 10, 
               fundo = fundo) %>%
  footnote(general = "", general_title = "Fonte: LOA 2019 e OPI2019.")
```
